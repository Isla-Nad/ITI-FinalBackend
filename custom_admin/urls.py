...
urlpatterns = [
     ...
     path('clinics/delete/<int:pk>', ClinicDeleteView.as_view(), name='delete_clinic'),
     path('clinics/update/<int:pk>', ClinicUpdateView.as_view(), name='update_clinic'),
     path('clinicscases/', get_all_clinic_cases, name='clinics_cases_list'),
     path('clinicscases/create/', ClinicCaseCreateView.as_view(), name='create_clinic_case'),
     path('clinicscases/delete/<int:pk>', ClinicCaseDeleteView.as_view(), name='delete_clinic_case'),
     path('clinicscases/update/<int:pk>', ClinicCaseUpdateView.as_view(), name='update_clinic_case'),
